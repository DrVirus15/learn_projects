...
import com.shpp.p2p.cs.akoskovtsev.assignment6.hg.teest.*;

public class HistogramEqualizationTests extends SimpleProgram {
    public void init() {
        TeestRunnerPanel panel = new TeestRunnerPanel(new TeestSuite[]{new TeestSuite("histogramFor Tests", new TeestCase[]
                {new TeestCase() {
